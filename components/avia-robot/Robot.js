  ...
  return (
    <div className={styles.pageWrapper}>
      ...
      <p className={styles.intro}>
        {fr ? `Agent${name}, voici toutes les informations dont vous aurez besoin sur le robot de MOOHP — il sera crucial pour l'accomplissement de la mission AVIA.` : `Agent${name}, here is all the information you will need on the MOOHP robot—it will be crucial to the completion of mission AVIA.`}
      </p>
