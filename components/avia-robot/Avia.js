...
export default function Avia() {
    return (
        <div className={styles.background}>
            <h1 className={styles.header}><strong>Your Mission: AVIA 2023</strong></h1>
            <div className={styles.intro}>
                <img src="/logo/avia_logo.png" alt="AVIA Logo" className={styles.aviaLogo}/>
                <p>The Canadian Robotics Competition (CRC), a non-profit organisation that runs annual robotics competitions, has reached out to MOOHP for help.</p><br></br>
                <p>This multidisciplinary competition requires the involvement of all agents at MOOHP. Integrating computer science, technology, and engineering with visual arts and humanities; the Machinery, Manufacturing, Hacking, Virtual Network, Marketing and divisions are integral to this mission!</p>
