...
const Puzzle = () => {
  ...
  return (
    <div className={classNames(styles.puzzleArea, { ' hide': revealed })}>
      ...
      <h3 className={classNames('puzzleHint', { 'fade': puzzleSolved })}>{lang ? 'Résoudre le puzzle !' : 'Solve the puzzle!'}<br />{lang ? 'Effectuez un appui long sur une pièce puis faites-la glisser' : 'Press and hold a puzzle piece to drag'}</h3>
