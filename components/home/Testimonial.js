...
const Testimonial = ({ fr }) => {
    return(
        <div className={styles.testimonialContainer}>
          ...
          <p className={styles.name}>{fr ? 'Jared Lewis, ancien élève de M.A.R.I. et ' : 'Jared Lewis, M.A.R.I. Alumni & '}<Link className={styles.hintLink} href={fr ? '/fr/moohp' : '/moohp'}>{fr ? 'fondateur de MOOHP' : 'MOOHP Founder'}</Link></p>
            </div>
            <img 
