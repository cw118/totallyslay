    ...
    return(
        <div className={styles.div}>
            <div className={styles.schoolContainer}>
                <p>
                    {fr ? `The Marianopolis Academic Research Institute (M.A.R.I.) is a
                        ...
                        and arts as well as certificates that offer opportunities 
                        to our students to be involved in important social causes.` 
                        :
                        `L’institut de recherche académique de Marianopolis (M.A.R.I.) 
